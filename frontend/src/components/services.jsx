        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7">
              ...
              <Link to='/PlanningServices' className='btn btn-outline-danger d-flex mx-auto w-25'>know more</Link>
            </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-7">
              ...
              <Link to='/LaunchingServices' className='btn btn-outline-danger d-flex mx-auto w-25'>know more</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7">
              ...
              <Link to='/ManagingServices' className='btn btn-outline-danger d-flex mx-auto w-25'>know more</Link>
            </div>
            <div className="col-md-5">
              <video src={manage} alt='plan'className='m-vid' controls loop autoPlay muted />
            </div>
          </div>
        </div>
      </section>
